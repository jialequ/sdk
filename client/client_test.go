...
func TestClientAddHookCheckOrder(t *testing.T) {
	t.Parallel()
...
func TestClientConcurrencyRequests(t *testing.T) {
	t.Parallel()
...
func TestClientHeaderWithServer(t *testing.T) {
...
func TestClientCookieWithServer(t *testing.T) {
	t.Parallel()
...
func TestClientCookieJarResponse(t *testing.T) {
	t.Parallel()
...
func TestClientQueryParamWithServer(t *testing.T) {
	handler := func(c fiber.Ctx) error {
...
func TestClientPathParamWithServer(t *testing.T) {
	app, dial, start := createHelperServer(t)
...
func TestClientTLSError(t *testing.T) {
	t.Parallel()
...
func TestClientTLSEmptyTLSConfig(t *testing.T) {
	t.Parallel()
...
func TestSetConfigToRequest(t *testing.T) {
	t.Parallel()
...
func TestClientSetProxyURL(t *testing.T) {
	t.Parallel()
