...
func TestRequestHeaderWithServer(t *testing.T) {
	t.Parallel()
...
func TestRequestUserAgentWithServer(t *testing.T) {
	t.Parallel()
...
func TestRequestCookieWithServer(t *testing.T) {
	t.Parallel()
	handler := func(c fiber.Ctx) error {
		return c.SendString(
...
func TestRequestRefererWithServer(t *testing.T) {
	t.Parallel()
	handler := func(c fiber.Ctx) error {
...
func TestRequestQueryStringWithServer(t *testing.T) {
	t.Parallel()
	handler := func(c fiber.Ctx) error {
...
func TestRequestBodyWithServer(t *testing.T) {
	t.Parallel()
...
func TestRequestErrorBodyWithServer(t *testing.T) {
	t.Parallel()
...
func TestRequestTimeoutWithServer(t *testing.T) {
	t.Parallel()
