...
import (
	...
	"github.com/jialequ/sdk/middleware/requestid"
...
func TestLoggerlocals(t *testing.T) {
	t.Parallel()
	app := fiber.New()
...
func TestLoggerDone(t *testing.T) {
	t.Parallel()
...
func TestLoggerErrorTimeZone(t *testing.T) {
	t.Parallel()
	app := fiber.New()
...
func TestLoggerErrorOutputWithoutColor(t *testing.T) {
	t.Parallel()
...
func TestLoggerWithLatencyDefaultFormat(t *testing.T) {
	buff := bytebufferpool.Get()
	defer bytebufferpool.Put(buff)
	app := fiber.New()
...
func TestReqHeaderHeader(t *testing.T) {
	t.Parallel()
	buf := bytebufferpool.Get()
	defer bytebufferpool.Put(buf)
...
func TestLoggerByteSentStreaming(t *testing.T) {
	t.Parallel()
	app := fiber.New()
...
func TestLoggerEnableColors(t *testing.T) {
	t.Parallel()
	o := new(fakeOutput)
	app := fiber.New()
