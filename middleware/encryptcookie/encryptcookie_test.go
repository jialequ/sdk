...
func TestMiddlewareEncryptCookie(t *testing.T) {
	t.Parallel()
	app := fiber.New()
...
func TestEncryptCookieNext(t *testing.T) {
	t.Parallel()
	app := fiber.New()
...
func TestEncryptCookieExcept(t *testing.T) {
	t.Parallel()
	app := fiber.New()
...
func TestEncryptCookieCustomEncryptor(t *testing.T) {
	t.Parallel()
	app := fiber.New()
