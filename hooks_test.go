...
func TestHookOnRoute(t *testing.T) {
	t.Parallel()
	app := New()
...
func TestHookOnRouteMount(t *testing.T) {
	t.Parallel()
	app := New()
	subApp := New()
	app.Use("/sub", subApp)
...
func TestHookOnName(t *testing.T) {
	t.Parallel()
	app := New()
...
func TestHookOnNameError(t *testing.T) {
	t.Parallel()
	app := New()
	defer func() {
...
func TestHookOnGroup(t *testing.T) {
	t.Parallel()
	app := New()
...
func TestHookOnGroupMount(t *testing.T) {
	t.Parallel()
	app := New()
	micro := New()
	micro.Use("/john", app)
...
func TestHookOnGroupName(t *testing.T) {
	t.Parallel()
	app := New()
...
func TestHookOnGroupNameError(t *testing.T) {
	t.Parallel()
	app := New()
	defer func() {
		if err := recover(); err != nil {
...
func TestHookOnListen(t *testing.T) {
	t.Parallel()
...
func TestHookOnListenPrefork(t *testing.T) {
	t.Parallel()
	app := New()
...
func TestHookOnHook(t *testing.T) {
	app := New()
...
func TestHookOnMount(t *testing.T) {
	t.Parallel()
	app := New()
	app.Get("/", testSimpleHandler).Name("x")
