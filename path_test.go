...
func TestPathparseRoute(t *testing.T) {
	t.Parallel()
	var rp routeParser
...
func TestPathmatchParams(t *testing.T) {
	t.Parallel()
...
func TestUtilsGetTrimmedParam(t *testing.T) {
	t.Parallel()
	res := GetTrimmedParam("")
	require.Equal(t, "", res)
	res = GetTrimmedParam("*")
...
func TestUtilsRemoveEscapeChar(t *testing.T) {
	t.Parallel()
