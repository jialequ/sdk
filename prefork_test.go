...
func TestAppPreforkChildProcess(t *testing.T) {
	// Reset test var
...
func TestAppPreforkMasterProcess(t *testing.T) {
	// Reset test var
	testPreforkMaster = true
...
func TestAppPreforkChildProcessNeverShowStartupMessage(t *testing.T) {
	setupIsChild(t)
	defer teardownIsChild(t)
